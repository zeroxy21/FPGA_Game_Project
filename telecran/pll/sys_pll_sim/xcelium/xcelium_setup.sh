...
# ACDS 24.1 1077 linux 2025.10.12.16:10:11
...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/agheles/intelFPGA_lite/24.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/sys_pll.vo"
fi
